...
export default function News() {
  ...
  return (
    <section className="w-full h-full 2xl:h-screen flex flex-col items-start mx-auto md:px-20 mb-20">
      ...
      <div className="flex md:mt-10 w-full h-full flex-col items-start">
